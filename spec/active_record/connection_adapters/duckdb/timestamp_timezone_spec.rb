...
RSpec.describe 'Timestamp timezone handling' do
  ...
  describe 'timestamp storage and retrieval' do
    ...
    context 'with raw SQL timestamp handling' do
    ...
    context 'with the timestamps column (created_at, updated_at)' do
    ...
    context 'with plain DuckDB TIMESTAMP and TIMESTAMPTZ columns' do
      include_context 'with Europe/Berlin timezone'
